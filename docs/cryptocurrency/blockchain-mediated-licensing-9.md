...
recording/neighboring rights), and their functional roles.<sup>564</sup> Sellin and Seppälä discussed the general functions of each copyright in its lifecycle from creation-to-consumption.<sup>565</sup>
